...
<body>
  ...
  <div class="container">
   ...
   <form class="col s12" action="insertt" method="post">
      <div class="row">
        ...
        <div class="input-field col s6">
          <input id="idcurso" name="idcurso" type="text" class="validate">
    ...
    <a class="waves-effect waves-light cyan darken-4 btn" href="listt">Cancelar</a>
    </div>
    </form>
  </div>
